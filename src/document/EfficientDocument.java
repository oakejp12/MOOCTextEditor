...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		/**
		 * List will preserve separate strings that are either words or punctuation
		 * If word, count the number of syllables in the word...
		 */
		...
		// e.g. I'm here to spread joy. What what ----------------> 2 sentences
		String last = (tokens.size() > 0) ? tokens.get(tokens.size() - 1) : null;
		if (!(last == null) && isWord(last)) numSentences++;
	}
